...
const BANNERS = [
  { titleKo: "AI가 추천하는 나만의 병원 찾기", titleEn: "Find Your Perfect Clinic with AI", subKo: "심평원 데이터 기반 맞춤 추천", subEn: "Personalized recommendations based on HIRA data", href: "/ai-search", bg: "from-pink-500 to-rose-400", cta: { ko: "AI 추천 시작", en: "Start AI Search" } },
