...
const BANNERS = [
  { titleKo: "AI가 추천하는 나만의 병원 찾기", titleEn: "Find Your Perfect Clinic with AI", subKo: "심평원·구글·네이버 등 다양한 평판 데이터를 AI가 종합 분석하여 추천드립니다.", subEn: "Combining data from HIRA and Google to find the best recommendations for you.", href: "/ai-search", bg: "from-slate-500 to-slate-500", cta: { ko: "AI 추천 시작", en: "Start AI Search" } },
  ...
  { titleKo: "실제 후기를 커뮤니티에서 확인하세요", titleEn: "Check Real Reviews in Community", subKo: "K-Pop, K-Food, K-Drama까지 다양한 토픽", subEn: "K-Pop, K-Food, K-Drama & more topics", href: "/community", bg: "from-slate-500 to-teal-400", cta: { ko: "커뮤니티 가기", en: "Go to Community" } },
];
